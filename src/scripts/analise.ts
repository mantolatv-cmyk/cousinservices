...
const PRECO_M2_POR_CIDADE: Record<string, number> = {
  // Capital - por bairro (Valores reduzidos em ~30% para serem mais conservadores para terrenos)
  'são paulo': 5600,
  'pinheiros': 14700,
  'moema': 13000,
  'vila mariana': 11900,
  ...
  'guarulhos': 2400,
  'osasco': 3500,
  'são bernardo do campo': 3800,
  'santo andré': 3500,
  'são caetano do sul': 5600,
  'barueri': 4200,
  'alphaville': 6600,
  'diadema': 2100,
  'cotia': 2200,
  'taboão da serra': 2400,
  'itapevi': 1700,
  'carapicuíba': 1500,
  'mauá': 1700,
  ...
  'sorocaba': 2100,
  'ribeirão preto': 2400,
  'são josé dos campos': 2800,
  'santos': 4200,
  'jundiaí': 2600,
  'piracicaba': 1900,
  'bauru': 1700,
  'marília': 1400,
  'presidente prudente': 1200,
  'araraquara': 1500,
  'franca': 1400,
  'bragança paulista': 2100,
  'atibaia': 2400,
  'itatiba': 2100,
  'mairiporã': 2400,
  'adamantina': 800,
  ...
  'pardinho': 700,
  'piracaia': 1400,
  'santa maria da serra': 500,
  'américo de campos': 500,
  'mirassol': 1000,
  'itapetininga': 1200,
  'são roque': 2100,
};
...
function getPrecoM2(cidade: string, bairro: string): { preco: number; fonte: string } {
  ...
  // Fallback
  return { preco: 1200, fonte: 'Estimativa genérica SP interior (conservadora)' };
}
